...
/// @brief https://github.com/ZeroKwok/mimetypes
const static MSStringMap<MSString> OPENMS_MIME_TYPE
{
	{".%", "application/x-trash"},
	...
	{".aaui", "application/vnd.adobe.acrobat.aaui+xml"},
